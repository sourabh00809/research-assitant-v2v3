  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cream">
      <div className="w-full max-w-md rounded-md border border-slate-300 bg-white p-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-600">You will be redirected to Clerk to sign in.</p>
        <a
          href="/sign-in"
          className="mt-6 inline-block rounded-md bg-emerald-700 px-6 py-3 text-sm font-bold text-white hover:bg-emerald-800"
        >
          Sign In with Clerk
        </a>
      </div>
